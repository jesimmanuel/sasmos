...
<link href="{{ asset('sass/responsive.css') }}" rel="stylesheet">
    ...
    <style>
        ...
        .ms-dropdown.open .dropdown-content {
            display: block;
        }
...
{{--                <span class="material-icons-outlined position-absolute me-3 translate-middle-y end-0 top-50 search-close">close</span>--}}
                <div class="search-popup p-3" style="display: none;">
...
{{--                                <span class="material-icons-outlined position-absolute me-3 translate-middle-y end-0 top-50 mobile-search-close">close</span>--}}
                        ...
                        <div class="card-footer text-center bg-transparent" style="display: none;">
...
<script>
    flatpickr("#dateRangepo", {
        mode: "range",  // Enables selection of From & To Date
        ...
        onOpen: function (selectedDates, dateStr, instance) {
            instance.clear();  // Clears selection when reopened
        }
    });

    flatpickr("#dateRangerm", {
        mode: "range",  // Enables selection of From & To Date
        dateFormat: "Y-m-d",  // Format of the selected date
        allowInput: true,  // Allows manual input
        clickOpens: true, // Open calendar on click
...
<script>
    function toggleDropdown() {
        document.querySelector('.ms-dropdown').classList.toggle('open');
    }
    ...
    function updateSelection() {
        ...
        checkboxes.forEach((checkbox) => {
            selectedOptions.push(`<span class="selected-items">${checkbox.value}</span>`);
        });
    ...
    function filterOptions() {
        ...
        let options = document.querySelectorAll("#options-list label");
    ...
    document.addEventListener("click", function (event) {
        if (!event.target.closest(".ms-dropdown")) {
            document.querySelector('.ms-dropdown').classList.remove('open');
        }
    });
</script>
