...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/assets/plugins/metismenu/metisMenu.min.css">
  <link rel="stylesheet" type="text/css" href="../assets/assets/plugins/metismenu/mm-vertical.css">
  <link rel="stylesheet" type="text/css" href="../assets/assets/plugins/simplebar/css/simplebar.css">
  <!--bootstrap css-->
    ...
    <nav class="navbar navbar-expand align-items-center gap-4">
      ...
      <div class="search-bar flex-grow-1">
        <div class="position-relative">
          <input style="display: none;" class="form-control rounded-5 px-5 search-control d-lg-block d-none" type="text" placeholder="Search">
  ...
  <!--end top header-->
   ...
   <aside class="sidebar-wrapper" data-simplebar="true">
       ...
       <div class="sidebar-header">
               ...
               <div class="row">
                   <div class="col"></div>
                   <div class="col"><img src="../assets/sasmos_logo.jpg" height="60px"; width="230px;"></div>
                   <div class="col"></div>
               </div>
    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
            ...
            <li>
                ...
                <ul>
                    <li><a href="purchase_orders"><i class="material-icons-outlined">arrow_right</i>Manage Purchase Order</a></li>
                    <li><a href="view_purchase_orders"><i class="material-icons-outlined">arrow_right</i>View Purchase Order</a></li>
                </ul>
            </li>
...
{{--  </div>--}}
  ...
  <div class="modal fade schedule-details design-modal" id="pwdModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
              ...
              <div class="modal-body pb-2">
                  ...
                  <div class="form-group">
                      <form action="changepw" name="frm-login" enctype="multipart/form-data" method="post" >
                          {{ csrf_field() }}
                          @if(session()->has('successrev'))
                              <div class="col-12" id="successrevid">
                                  <span ><font color="#9acd32" size="4">Saved Successfully!..</font></span>
                              </div>
                          @endif
                          ...
                          <div class="col-md-12" >
                              ...
                              <input type="password" required class="form-control" name="newpw" id="newpw" placeholder="New Password..." value="">
                              <span ><font color="red">{{ $errors->first('newpw') }}</font></span>
                          </div>
                          <div style="height:10px;"></div>
...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Dec 2024 09:30:53 GMT -->
</html>
<script>
